...
var IG_XST = '';
var IG_CST = '';
var IG_LIGHTSTREAMER_END_POINT = '';
...
IG_XST = tokens['x-security-token'];
IG_CST = tokens.cst;
IG_LIGHTSTREAMER_END_POINT = tokens.lightstreamerEndpoint;
            ...
            _request('GET', '/session/encryptionKey') // retrieve encryptionKey and timeStamp for encryption
                ...
                .then(r => {
                    if (r.status !== 200) {
                        ...
                        IG_CST = r.headers.cst;
                        IG_XST = r.headers['x-security-token'];
                        IG_LIGHTSTREAMER_END_POINT = r.body.lightstreamerEndpoint;
...
function connectToLightstreamer() {
    ...
    requirejs(['LightstreamerClient'], function (LightstreamerClient) {
        ...
        lsClient.connectionDetails.setPassword('CST-' + IG_CST + '|XST-' + IG_XST);
